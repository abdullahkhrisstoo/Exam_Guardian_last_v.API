...
namespace Exam_Guardian.infra.Service
{
    public class AuthService : IAuthService
    {
        ...
        public async Task DeleteUser(int id) => await _authRepository.DeleteUser(id);
        public async Task UpdateUserPassword(UpdatePasswordViewModel updateProctorPasswordViewModel) => await _authRepository.UpdateUserPassword(updateProctorPasswordViewModel);
